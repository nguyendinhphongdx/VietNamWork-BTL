...
function setup() {
    ...
    listJobs.push(new Job('daesun.png', 'Automation Tester1', 'BKAV', '1500', 'Ha Noi', 'hot'));
    listJobs.push(new Job('hybird.png', 'Automation Tester2', 'BKAV', '1500', 'Ha Noi', 'hot'));
    listJobs.push(new Job('Neo.png', 'Automation Tester3', 'BKAV', '1500', 'Ha Noi', 'hot'));
    localStorage.setItem('listJobs', JSON.stringify(listJobs));
    listCompany.push(new Company('bkav.png', 'BKAV', 'Hà Nội', 'still'));
    listCompany.push(new Company('Nec.png', 'VNPT', 'Hà Nội', 'still'));
    listCompany.push(new Company('Neo.png', 'VINGROUP', 'Hà Nội', 'still'));
    listCompany.push(new Company('VinD.png', 'SYMPHONY', 'Hà Nội', 'still'));
